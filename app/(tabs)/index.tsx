    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <TouchableOpacity style={styles.backButton} onPress={() => router.push('/main-dashboard')}>
      ...
      >
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/outbreak-alert/livetracker')}
            activeOpacity={0.7}
          >
          ...
          <TouchableOpacity 
            style={styles.highlightCard}
            onPress={() => router.push('/outbreak-alert/outbreakdetails')}
            activeOpacity={0.7}
          >
            <View style={styles.highlightHeader}>
          ...
          <TouchableOpacity 
            style={styles.highlightCard}
            onPress={() => router.push('/outbreak-alert/safetytips')}
            activeOpacity={0.7}
          >
            <View style={styles.highlightHeader}>
